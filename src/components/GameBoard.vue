  ...
  methods: {
    ...
    matchCards(img1, img2) {
      if (img1 === img2) {
        ...
        this.cardOne = this.cardTwo = ""; // now reset the cardOne & cardTwo variables to empty strings, so we can use them again
      ...
      setTimeout(() => {
        ...
        this.cardOne = this.cardTwo = ""; // reset the cardOne & cardTwo variables to empty string
        this.disableDeck = false;
        return;
      }, 1200);
    },
